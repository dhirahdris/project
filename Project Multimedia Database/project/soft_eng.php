...
<body>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item active" href="../project/soft_eng.php">Software Engineering</a>
              </div>
           </li>
           <li class="nav-item">
  ...
  <div class="team-boxed">
        <div class="container">
            <div class="intro">
                <h2 class="text-center">Department Software Engineering</h2>
			...
			$sql = "SELECT lecturer.Name as 'Name', lecturer.RoomNo as 'RoomNo', lecturer.Audio as 'Audio', lecturer.Pic as 'Pic', block.Name as 'Block' 
				FROM `lecturer`
        			...
        			WHERE lecturer.department_id = '4'";
