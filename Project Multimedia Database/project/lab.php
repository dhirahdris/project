...
<body>
  ...
  <div class="row">
    <div class="col-lg-12 text-center">
      <h1 class="mt-5">LAB FACULTY INFOMATION & COMMUNICATION TECHNOLOGY</h1><br/>
    </div>
  </div>
  <div class="row">
    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for lab.." title="Type in a name">
  </div>
  <div class="row">
  ...
  <tbody>
	...
	$sql = "SELECT room.Name as 'Name', room.Location as 'Location', block.Name as 'Block', in_charge.Name as 'InCharge' 
		...
		JOIN in_charge ON room.person_id = in_charge.person_id
        	...
        	WHERE room.Name NOT LIKE '%Bilik Kuliah%' 
        	ORDER BY room.Location ASC";
