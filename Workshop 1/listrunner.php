...
$sql2 = "SELECT COUNT(UserId) AS TotalUserRunner
		FROM user
		WHERE type = 'runner'";
...
$sql = "SELECT UserId, FirstName, LastName, Gender, Email, CountryCode, CountryName
		FROM user
		JOIN country
		USING (CountryCode)
		WHERE type = 'runner'
  ...
  $("#myInput").on("keyup", function() {
    ...
    $("#myTable tr").filter(function() {
      $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
			...
			<table align="right" border="0" width="80%" cellpadding="0" cellspacing="0" >
              <td width="20%" style="font-size: 130%"> Total user as a runner : </td>
              <td width="26%" style="font-size: 130%"><?php echo $data ["TotalUserRunner"]; ?> runners</td>
              <td></td>
            </table>
	...
	?>
            ...
            <table align="right" border="0" width="85%" cellpadding="0" cellspacing="0">
              <td><hr></td>
              <td width="30%" align="center"><h2><font color="#000063">List Of Runner</font></h2></td>
              <td><hr></td>
            </table>
			<br></br>		
			...
			<div id="dvData">
              <table align="right" border="0" width="85%" cellpadding="2" cellspacing="0">
                <tr>
			...
			?>
                ...
                <tr>
				  ...
				  <td width="8%" style="border-bottom: 1px solid #b3b3b3;" align="center"> <?php echo $row ["Gender"]; ?> </td>
				  ...
				  <td style="border-bottom: 1px solid #b3b3b3;" align="center"><a href = "updaterunner.php?UserId=<?php echo $row ["UserId"]; ?>">Update</a> &nbsp; <a href = "deleterunner.php?UserId=<?php echo $row ["UserId"]; ?>">Delete</a></td>
                </tr>
