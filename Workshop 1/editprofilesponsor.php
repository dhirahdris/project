...
<br></br>
            ...
            <table align="center" border="0" width="50%" cellpadding="0" cellspacing="0">
			  ...
			  <table align="center" border="0" cellpadding="0" cellspacing="0"  style="font-size:17px">
                      <tr>
                        <td width="42%" align="left"><i><b><font color="#e00000">* </font><font color="black">All field required</font></b></i></td>
                      </tr>
			  </table>
              ...
              <table align="center" border="0" width="33%" cellpadding="7" cellspacing="0">
			   <br></br>
				...
				<tr>
                  ...
                  <td><input class="Minput" type="email" name="Email" maxlength="100" size = "30" step = "0.01" value="<?php echo $data ["Email"];?>" autofocus required></td>
				<tr>
				<td></td>
				<td></td>
				</tr>
