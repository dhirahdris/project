...
<br></br>
	...
	<table align = "center" width="50%" border="0" cellpadding="1" cellspacing="0">
                <tr>
					<td><input class="button" type="submit" value="Cancel" onclick="goBack()"></td>
...
<br></br>
            ...
            <table align="center" border="0" width="50%" cellpadding="0" cellspacing="0">
              <td><hr></td>
              <td width="50%" align="center"><h2><font color="#000063">Update Runner Information</font></h2></td>
              <td><hr></td>
			 
            </table>
            <!-- Register Books Content -->
            <form action="updatesponsor_action.php" method="post">
              <table align="center" border="0" width="33%" cellpadding="7" cellspacing="0">
			   <br></br>
                <tr>
                  <th align="center" width="40%">First Name</th>
                  <td><input type = "hidden" name = "UserId" value="<?php echo $data ["UserId"];?>"><input class="Minput" type="text" maxlength="25" name="FirstName" value="<?php echo $data ["FirstName"];?>" autofocus required></td>
                </tr>
				<tr>
                  <th align="center" width="30%">Last Name</th>
                  <td><input class="Minput" type="text" name="LastName" maxlength="25" value="<?php echo $data ["LastName"];?>" autofocus required></td>
                </tr>
                <tr>
				...
				<tr>
                  ...
                  <td><input class="Minput" type="text" name="Email" step = "0.01" maxlength="100" value="<?php echo $data ["Email"];?>" autofocus required></td>
				<tr>
				<td></td>
				<td></td>
				</tr>
