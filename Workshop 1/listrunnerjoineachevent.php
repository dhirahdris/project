...
$sql2 = "SELECT COUNT(UserId) AS TotalRunner
		FROM user 
		JOIN registration
		USING (UserId)
...
function goBack() {
    window.history.back();
		   ...
		   <table align="center" border="0" width="70%" cellpadding="0" cellspacing="0" >
              <td width="22%" style="font-size: 130%"> Total user as a runner : </td>
              <td width="30%" style="font-size: 130%"><?php echo $data ["TotalRunner"]; ?> runners</td>
              <td></td>
            </table>
