...
<br></br>
	...
	<table align = "center" width="48%" border="0" cellpadding="1" cellspacing="0">
                <tr>
					...
					<td width="30%" align="center"><a href="sponsorchangepass.php" class="menu">Change Password</a></td>
					<td width="35%" align="right"><a href="logout.php" class="menu" onClick="return confirm('Are You Sure?')">LOGOUT</a></td>			
                </tr>
	</table>
...
function goBack() {
    window.history.back();
		...
		<br></br>
            ...
            <form action="editprofilesponsor.php" method="post" align="center">
